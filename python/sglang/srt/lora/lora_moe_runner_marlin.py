...
Uses Marlin int4/int8 kernels for the base MoE projections. LoRA deltas
are injected via optional hooks, not hard-coded into this runner.
"""
...
class MarlinLoraRunnerCore:
    """
    MoE runner using Marlin kernels for base projections, with optional hooks.

    Pipeline:
      1. moe_wna16_marlin_gemm (gate_up)
      1.5. hooks.after_gate_up (if provided)
      2. silu_and_mul
      3. moe_wna16_marlin_gemm (down)
      3.5. hooks.after_down (if provided)
      4. moe_sum_reduce
    """
